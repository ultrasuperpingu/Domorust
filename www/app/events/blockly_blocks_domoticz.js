define(['blockly', 'blockly-blocks', 'blockly-msg-en', 'app/events/blockly_messages_domoticz_en.js'], function () {
	var switchesAF = [];
	var switchesGL = [];
	var switchesMR = [];
	var switchesSZ = [];
	...
	$.ajax({
		url: "domorust-api/devices?filter=light&used=true&order=Name&displayhidden=1",
		async: false,
		dataType: 'json',
	...
	$.ajax({
		url: "domorust-api/devices?filter=temp&used=true&order=Name&displayhidden=1",
		async: false,
		dataType: 'json',
		success: function (data) {
			if (typeof data.result != 'undefined') {
	...
	$.ajax({
		url: "domorust-api/devices?filter=weather&used=true&order=Name&displayhidden=1",
		async: false,
		dataType: 'json',
		success: function (data) {
			if (typeof data.result != 'undefined') {
	...
	$.ajax({
		url: "domorust-api/devices?filter=utility&used=true&order=Name&displayhidden=1",
		async: false,
		dataType: 'json',
		success: function (data) {
			if (typeof data.result != 'undefined') {
	...
	$.ajax({
		url: "domorust-api/devices?filter=zwavealarms&used=true&order=Name&displayhidden=1",
		async: false,
		dataType: 'json',
		success: function (data) {
			if (typeof data.result != 'undefined') {
	...
	$.ajax({
		url: "domorust-api/scenes?order=Name&displayhidden=1",
		async: false,
		dataType: 'json',
		success: function (data) {
			if (typeof data.result != 'undefined') {
	...
	$.ajax({
		url: "domorust-api?type=command&param=getcameras&order=Name&displayhidden=1",
		async: false,
		dataType: 'json',
		success: function (data) {
			if (typeof data.result != 'undefined') {
	...
	$.ajax({
		url: "domorust-api/user_variables",
		async: false,
		dataType: 'json',
		success: function (data) {
			if (typeof data.result != 'undefined') {
