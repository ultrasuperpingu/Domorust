define(['app', 'livesocket'], function (app) {
	app.controller('WeatherController', function ($scope, $rootScope, $location, $http, $interval, $route, $routeParams, deviceApi, permissions, livesocket) {
		...
		RefreshWeathers = function () {
			...
			/*livesocket.getJson("domorust-api/devices?filter=weather&used=true&order=[Order]&lastupdate=" + $.LastUpdateTime + "&plan=" + roomPlanId, function (data) {
			...
			$.ajax({
				url: "domorust-api/devices?filter=weather&used=true&order=[Order]&lastupdate=" + $.LastUpdateTime + "&plan=" + roomPlanId,
				async: false,
				dataType: 'json',
		...
		ShowWeathers = function () {
			...
			$.ajax({
				url: "domorust-api/devices?filter=weather&used=true&order=[Order]&plan=" + roomPlanId,
				async: false,
				dataType: 'json',
				success: function (data) {
					if (typeof data.result != 'undefined') {
