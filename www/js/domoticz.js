...
function HandleProtection(isprotected, callbackfunction) {
	...
	bootbox.prompt($.t("Please enter Password") + ":", function (result) {
		if (result === null) {
			...
			//verify password
			$.ajax({
				url: "domorust-api?type=command&param=verifypasscode" +
				"&passcode=" + result,
				async: false,
				dataType: 'json',
...
function SendX10Command(idx, switchcmd, passcode) {
	...
	$.ajax({
		method:"POST",
		url: "domorust-api/devices/" + $.devIdx +"/commands/" + switchcmd +
		"&level=0" +
		"&passcode=" + passcode,
		async: false,
		dataType: 'json',
...
function SwitchLightInt(idx, switchcmd, passcode) {
	...
	$.ajax({
		method:"POST",
		url: "domorust-api/devices/" + idx +"/commands/" + switchcmd +
		"?idx=" + idx +
		"&switchcmd=" + switchcmd +
		"&level=0" +
		"&passcode=" + passcode,
...
function SwitchSelectorLevelInt(idx, levelName, levelValue, passcode) {
	...
	$.ajax({
		method:"POST",
		url: "domorust-api/devices/" + idx +"/commands/set_level" +
		"?idx=" + idx +
...
function SwitchSceneInt(idx, switchcmd, passcode) {
	...
	$.ajax({
		url: "domorust-api?type=command&param=switchscene&idx=" + idx +
		"&switchcmd=" + switchcmd +
		"&passcode=" + passcode,
		async: false,
		dataType: 'json',
...
function ResetSecurityStatus(idx, switchcmd) {
	...
	$.ajax({
		url: "domorust-api?type=command&param=resetsecuritystatus&idx=" + idx + "&switchcmd=" + switchcmd,
		async: false,
		dataType: 'json',
		success: function (data) {
			//wait 1 second
...
function SwitchLayout(layout) {
	...
	if (layout == "Restart") {
		bootbox.confirm($.t("Are you sure to Restart the system?"), function (result) {
			if (result == true) {
				$.ajax({
					url: "domorust-api?type=command&param=system_reboot",
					async: true,
					dataType: 'json',
					success: function (data) {
					},
		...
		bootbox.confirm($.t("Are you sure to Shutdown the system?"), function (result) {
			if (result == true) {
				$.ajax({
					url: "domorust-api?type=command&param=system_shutdown",
					async: true,
					dataType: 'json',
					success: function (data) {
					},
...
function SetDimValue(idx, value) {
	...
	$.ajax({
		method:"POST",
		url: "domorust-api/devices/" + idx +"/commands/set_level?" + "idx=" + idx + "&switchcmd=Set%20Level&level=" + value,
		async: false,
		dataType: 'json'
	});
}
...
function chartPointClick(event, retChart) {
	...
	bootbox.confirm($.t("Are you sure to remove this value at") + " ?:\n\n" + $.t("Date") + ": " + dateString + " \n" + $.t("Value") + ": " + event.point.y, function (result) {
		if (result == true) {
			$.ajax({
				url: "domorust-api?type=command&param=deletedatapoint&idx=" + $.devIdx + "&date=" + dateString,
				async: false,
				dataType: 'json',
				success: function (data) {
					if (data.status == "OK") {
	...
	$(divId).dialog({
		...
		open: function () {
			...
			if ( HWType.indexOf('Panasonic') >= 0) {
				...
				$.ajax({
					url: "domorust-api/devices/" + devIdx,
					async: true,
					dataType: 'json',
					success: function (data) { 
						hwId = data.result[0].HardwareID;
						$.ajax({
							url: "domorust-api/hardwares",
							async: true,
							dataType: 'json',
							success: function (data) {
								// TODO: ask directly for the good hardware...
...
function ShowCurrentLog(contentdiv, backfunction, id, name, switchtype) {
	...
	$.DayChart.highcharts({
		chart: {
			...
			events: {
				load: function () {
					$.getJSON("domorust-api/devices/"+id+"/graph?sensor=counter&idx=" + id + "&range=day", function (data) {
	...
	$.MonthChart.highcharts({
		chart: {
			...
			events: {
				load: function () {
					$.getJSON("domorust-api/devices/"+id+"/graph?sensor=counter&idx=" + id + "&range=month", function (data) {
						if (typeof data.result != 'undefined') {
		...
		chart: {
			...
			events: {
				load: function () {
					...
					$.getJSON("domorust-api/devices/"+id+"/graph?sensor=counter&idx=" + id + "&range=year", function (data) {
						if (typeof data.result != 'undefined') {
...
function ShowUVLog(contentdiv, backfunction, id, name) {
	...
	$.DayChart.highcharts({
		chart: {
			...
			events: {
				load: function () {
					$.getJSON("domorust-api/devices/"+id+"/graph?sensor=uv&idx=" + id + "&range=day", function (data) {
						if (typeof data.result != 'undefined') {
		...
		chart: {
			...
			events: {
				load: function () {
					...
					$.getJSON("domorust-api/devices/"+id+"/graph?sensor=uv&idx=" + id + "&range=month", function (data) {
						if (typeof data.result != 'undefined') {
		...
		chart: {
			...
			events: {
				load: function () {
					...
					$.getJSON("domorust-api/devices/"+id+"/graph?sensor=uv&idx=" + id + "&range=year", function (data) {
						if (typeof data.result != 'undefined') {
...
function ShowWindLog(contentdiv, backfunction, id, name) {
	...
	$.DayChart.highcharts({
		chart: {
			...
			events: {
				load: function () {
					$.getJSON("domorust-api/devices/"+id+"/graph?sensor=wind&idx=" + id + "&range=day", function (data) {
						if (typeof data.result != 'undefined') {
	...
	$.DirectionChart.highcharts({
		chart: {
			...
			events: {
				load: function () {
					$.getJSON("domorust-api/devices/"+id+"/graph?sensor=winddir&idx=" + id + "&range=day", function (data) {
	...
	$.MonthChart.highcharts({
		chart: {
			...
			events: {
				load: function () {
					$.getJSON("domorust-api/devices/"+id+"/graph?sensor=wind&idx=" + id + "&range=month", function (data) {
						if (typeof data.result != 'undefined') {
		...
		chart: {
			...
			events: {
				load: function () {
					...
					$.getJSON("domorust-api/devices/"+id+"/graph?sensor=wind&idx=" + id + "&range=year", function (data) {
						if (typeof data.result != 'undefined') {
...
function ShowMonthReportRain(actMonth, actYear) {
	...
	$.getJSON("domorust-api/devices/"+$.devIdx+"/graph?sensor=rain&idx=" + $.devIdx + "&range=year&actmonth=" + actMonth + "&actyear=" + actYear,
		function (data) {
			var lastTotal = -1;
			$.each(data.result, function (i, item) {
...
function ShowYearReportRain(actYear) {
	...
	$.getJSON("domorust-api/devices/"+$.devIdx+"/graph?sensor=rain&idx=" + $.devIdx + "&range=year&actyear=" + actYear,
		function (data) {
			var lastTotal = -1;
			var lastMonth = -1;
			$.each(data.result, function (i, item) {
...
function ShowRainLog(contentdiv, backfunction, id, name) {
	...
	$.DayChart.highcharts({
		chart: {
			...
			events: {
				load: function () {
					$.getJSON("domorust-api/devices/"+id+"/graph?sensor=rain&idx=" + id + "&range=day", function (data) {
						if (typeof data.result != 'undefined') {
							var series = $.DayChart.highcharts().series[0];
							var datatable = [];
	...
	$.WeekChart.highcharts({
		chart: {
			...
			events: {
				load: function () {
					$.getJSON("domorust-api/devices/"+id+"/graph?sensor=rain&idx=" + id + "&range=week", function (data) {
						if (typeof data.result != 'undefined') {
	...
	$.MonthChart.highcharts({
		chart: {
			...
			events: {
				load: function () {
					$.getJSON("domorust-api/devices/"+id+"/graph?sensor=rain&idx=" + id + "&range=month", function (data) {
						if (typeof data.result != 'undefined') {
							var series = $.MonthChart.highcharts().series[0];
							var datatable = [];
							$.each(data.result, function (i, item) {
		...
		chart: {
			...
			events: {
				load: function () {
					...
					$.getJSON("domorust-api/devices/"+id+"/graph?sensor=rain&idx=" + id + "&range=year", function (data) {
						if (typeof data.result != 'undefined') {
							var series = $.YearChart.highcharts().series[0];
							var datatable = [];
							$.each(data.result, function (i, item) {
...
function ShowBaroLog(contentdiv, backfunction, id, name) {
	...
	$.DayChart.highcharts({
		chart: {
			...
			events: {
				load: function () {
					$.getJSON("domorust-api/devices/"+id+"/graph?sensor=temp&idx=" + id + "&range=day", function (data) {
						if (typeof data.result != 'undefined') {
							var series = $.DayChart.highcharts().series[0];
							var datatable = [];
							$.each(data.result, function (i, item) {
	...
	$.MonthChart.highcharts({
		chart: {
			...
			events: {
				load: function () {
					$.getJSON("domorust-api/devices/"+id+"/graph?sensor=temp&idx=" + id + "&range=month", function (data) {
						if (typeof data.result != 'undefined') {
							var series = $.MonthChart.highcharts().series[0];
							var datatable = [];
							$.each(data.result, function (i, item) {
	...
	$.YearChart.highcharts({
		chart: {
			...
			events: {
				load: function () {
					$.getJSON("domorust-api/devices/"+id+"/graph?sensor=temp&idx=" + id + "&range=year", function (data) {
						if (typeof data.result != 'undefined') {
							var series = $.YearChart.highcharts().series[0];
							var datatable = [];
...
function ShowFanLog(contentdiv, backfunction, id, name, sensor) {
	...
	$.DayChart.highcharts({
		chart: {
			...
			events: {
				load: function () {
					$.getJSON("domorust-api/devices/"+id+"/graph?sensor=fan&idx=" + id + "&range=day", function (data) {
						if (typeof data.result != 'undefined') {
							var series = $.DayChart.highcharts().series[0];
							var datatable = [];
	...
	$.MonthChart.highcharts({
		chart: {
			...
			events: {
				load: function () {
					$.getJSON("domorust-api/devices/"+id+"/graph?sensor=fan&idx=" + id + "&range=month", function (data) {
						if (typeof data.result != 'undefined') {
							var datatable1 = [];
							var datatable2 = [];
	...
	$.YearChart.highcharts({
		chart: {
			...
			events: {
				load: function () {
					$.getJSON("domorust-api/devices/"+id+"/graph?sensor=fan&idx=" + id + "&range=year", function (data) {
						if (typeof data.result != 'undefined') {
							var datatable1 = [];
							var datatable2 = [];
...
function ShowRGBWPopupInt(mouseX, mouseY, idx, Protected, MaxDimLevel, LevelInt, colorJSON, SubType, DimmerType) {
	...
	if (DimmerType && DimmerType === "rel")
	{
		...
		$('#rgbw_popup #popup_bright_up').off().click(function(){
			$.ajax({
				url: "domorust-api?type=command&param=brightnessup&idx=" + devIdx,
				async: false,
				dataType: 'json'
			});
		});
		$('#rgbw_popup #popup_bright_down').off().click(function(){
			$.ajax({
				url: "domorust-api?type=command&param=brightnessdown&idx=" + devIdx,
				async: false,
				dataType: 'json'
			});
		});
	...
	if (DimmerType && DimmerType === "rel" && ledType.bHasTemperature)
	{
		...
		$('#rgbw_popup #popup_warmer').off().click(function(){
			$.ajax({
				url: "domorust-api?type=command&param=warmer&idx=" + devIdx,
				async: false,
				dataType: 'json'
			});
		});
		$('#rgbw_popup #popup_colder').off().click(function(){
			$.ajax({
				url: "domorust-api?type=command&param=cooler&idx=" + devIdx,
				async: false,
				dataType: 'json'
			});
		});
...
function ThermUp() {
	$.ajax({
		method:"POST",
		url: "domorust-api/devices/" + $.devIdx  +"/commands/up" +
		"switchcmd=Up" +
		"&level=0",
		async: false,
		dataType: 'json',
...
function ThermDown() {
	$.ajax({
		method:"POST",
		url: "domorust-api/devices/" + $.devIdx  +"/command/down" +
		"?switchcmd=Down" +
		"&level=0",
		async: false,
		dataType: 'json',
...
function ThermUp2() {
	$.ajax({
		method:"POST",
		url: "domorust-api/devices/" + $.devIdx  +"/commands/run_up?" +
		"switchcmd=Run Up" +
		"&level=0",
		async: false,
		dataType: 'json',
...
function ThermDown2() {
	$.ajax({
		method:"POST",
		url: "domorust-api/devices/" + $.devIdx  +"/command/run_down?" +
		"switchcmd=Run Down" +
		"&level=0",
		async: false,
		dataType: 'json',
...
function ThermStop() {
	$.ajax({
		method:"POST",
		url: "domorust-api/devices/" + $.devIdx  +"/command/stop?" +
		"switchcmd=Stop" +
		"&level=0",
		async: false,
		dataType: 'json',
...
function SetSetpoint() {
	...
	$.ajax({
		url: "domorust-api?type=command&param=setsetpoint&idx=" + $.devIdx +
		"&setpoint=" + curValue,
		async: false,
		dataType: 'json',
		success: function (data) {
